...
PHYSICS_REQUIRED_2026 = tuple(SpecificCourseRequirement(rid, title, (code,), 3.0, source=PHYSICS_REQUIREMENT_SOURCE) for rid, title, code in (
    ("second_physics_lab_a1", "Physics Lab (A-1)", "PHY2105"), ("second_physics_quantum_1", "Quantum Mechanics (1)", "PHY3101"),
    ("second_physics_quantum_2", "Quantum Mechanics (2)", "PHY3102"), ("second_physics_em_1", "Electromagnetism (1)", "PHY3103"),
    ("second_physics_em_2", "Electromagnetism (2)", "PHY3104"), ("second_physics_statistical", "Statistical Physics", "PHY3106"),
    ("second_physics_lab_b1", "Physics Lab (B-1)", "PHY3107"), ("second_physics_mechanics_1", "Mechanics (1)", "PHY3110"),
    ("second_physics_mechanics_2", "Mechanics (2)", "PHY3111"),
))
...
EEE_REQUIRED_2026 = tuple(SpecificCourseRequirement(rid, title, (code,), 3.0, source=EEE_REQUIREMENT_SOURCE) for rid, title, code in (
    ("second_eee_data_structures","Data Structures","EEE2020"),("second_eee_electromagnetics_1","Electromagnetics (1)","EEE2030"),
    ("second_eee_basic_circuit_theory","Basic Circuit Theory","EEE2010"),("second_eee_digital_logic","Digital Logic Circuit","EEE2040"),
    ("second_eee_signals_systems","Signals and Systems","EEE2060"),("second_eee_electronic_circuits_1","Electronic Circuits (1)","EEE2050"),
    ("second_eee_basic_analog_lab","Basic Analog Experiment","EEE2111"),("second_eee_basic_digital_lab","Basic Digital Experiment","EEE3313"),
    ("second_eee_capstone","Electrical and Electronic Engineering Capstone Design","EEE4610"),
))
...
def qrm_double_major_candidate_2026(candidate_id:str)->DegreeScenario:
    ...
    base=qrm_double_major_shell_2026(); combined=base.requirements+candidate.spec.requirements
    ids=tuple(r.requirement_id for r in combined)
